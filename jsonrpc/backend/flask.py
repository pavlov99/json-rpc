...
class JSONRPCAPI(object):
    ...
    def jsonrpc(self):
        ...
        try:
            ...
            # the logger.info call here assumes that jsonrpc_request
            # is going to be of type JSONRPCRequest and not a JSONRPCBatchRequest
            # the logging should probably be done in handle_request
